...
![OpenAI](https://img.shields.io/badge/OpenAI_GPT--3.5-412991?style=for-the-badge&logo=openai&logoColor=white)
![Unity](https://img.shields.io/badge/Unity-000000?style=for-the-badge&logo=unity&logoColor=white)

**Methodologies**

![Agile](https://img.shields.io/badge/Agile-0052CC?style=for-the-badge&logo=jira&logoColor=white)
![User Centered Design](https://img.shields.io/badge/User--Centered_Design-FF6F00?style=for-the-badge)
...
**[JustitIA, RAG-Based Legal AI Chatbot](https://github.com/khushi-naik/justitIA)**
RAG chatbot using OpenAI embeddings, GPT-3.5-turbo, and Pinecone vector search to answer legal questions across the Terms of Service and Privacy Policy documents of 15 companies. Includes a 25-case evaluation benchmark, zero chat retention, and transparent source citations.

**[AR Vital Signs Monitor, HoloLens 2](https://github.com/khushi-naik/hmd-patient-vitals-display)**
Real time AR clinical monitoring app connecting Unity and C# to a Node.js backend over TCP, improving alarm detection accuracy by 18% and cutting clinician response time by 8.1%.

**[Healing Strokes, Collaborative Art Therapy Platform](https://github.com/khushi-naik/hci-art-app-2)**
Multiplayer turn-based web app with real time WebSocket synchronization, refined across 3 usability testing cycles that resolved 7+ system defects before deployment.

<br>

## Achievements

- Led a 4-member team to build a fully functional educational VR game in 48 hours at McGill's CareXR Hackathon 2026, using Claude Code
